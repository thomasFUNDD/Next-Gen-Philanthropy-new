  ...
  return (
    <div className="order-card-container">
            ...
            {({ isSubmitting }) => (
              <Form className="form">
                ...
                <div className="form-group">
                  ...
                  <Field type="text" name="addressInput2" id="addressInput2" placeholder="Optional Address line" />
                </div>
                <div className="form-group">
                  <label htmlFor="addressInput3">Shipping Address 3:</label>
                  <Field type="text" name="addressInput3" id="addressInput3" placeholder="Optional Address line" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <div className="calling-code-group">
                    ...
                    <Field type="text" name="mobileNumberInput" id="mobileNumberInput" placeholder="Mobile Number" />
                  </div>
                ...
                <div className="terms-group">
                  ...
                  <label htmlFor="termsCheckbox">
                    The UTA donor card is subject to the terms and conditions of which can be read here by completing this application you acknowledge that you have read the terms and conditions and agree to abide by them:
                    <a
      ...
      <footer className="footer">
        ...
        <p>
          The UTA Prepaid Mastercard® Card is issued by PayrNet Limited and licensed by Mastercard International Incorporated. PayrNet Limited is authorised by the Financial Conduct Authority (FCA) to conduct electronic money service activities under the Electronic Money Regulations 2011 (Firm Reference Number 900594). Mastercard is a registered trademark, and the circles design is a trademark of Mastercard International Incorporated.
        </p>
      </footer>
    </div>
  );
