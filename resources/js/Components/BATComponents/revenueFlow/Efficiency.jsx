            ...
            <div className="counting">
              <div className="mb-6">
                <div className="flex items-center space-x-[2px]">
                  <p className="text-lg font-bold text-babyBlue-dark">$5,230</p>
                  <span>
                    <svg
                      width="14"
                      height="12"
          ...
          <div className="status">
            <div className="mb-1.5 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="h-2.5 w-2.5 rounded-full bg-midPurple"></div>
            ...
            <div className="mb-1.5 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="h-2.5 w-2.5 rounded-full bg-babyBlue-mid"></div>
            ...
            <div className="mb-1.5 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="h-2.5 w-2.5 rounded-full bg-darkPurple"></div>
                <span className="text-sm font-medium text-bgray-600 dark:text-white">
                  Others
                </span>
              </div>
