  ...
  return (
    <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
      ...
      {status === "connect" ? (
        <button
          aria-label="none"
          className="text-base w-full text-midPurple font-medium h-12 rounded-md border border-midPurple hover:text-white hover:bg-midPurple transition duration-300 ease-in-out"
        >
          Connect
        </button>
      ) : (
        <button
          aria-label="none"
          className="text-base w-full text-midPurple h-12 rounded-md border border-midPurple hover:text-white bg-white hover:bg-midPurple transition duration-300 ease-in-out dark:bg-darkblack-600 dark:text-bgray-300"
        >
          Disconnect
        </button>
      )}
